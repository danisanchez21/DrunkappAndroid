...
public class RegisterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = (RecyclerView) v.findViewById(R.id.RegisterRecyclerview);
        RegisterRecyclerViewAdapter adpater = new RegisterRecyclerViewAdapter(controller.retrieveAllRegistries(), getContext());
        recyclerView.setAdapter(adpater);
        LinearLayoutManager lnyd = new LinearLayoutManager(getContext());
        lnyd.setOrientation(LinearLayoutManager.VERTICAL);
        recyclerView.setLayoutManager(lnyd);
