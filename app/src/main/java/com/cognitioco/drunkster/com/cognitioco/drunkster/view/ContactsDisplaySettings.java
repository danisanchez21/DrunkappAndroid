...
import com.cognitioco.drunkster.com.cognitioco.drunkster.com.cognitioco.drunkster.controller.ContactController;
 ...
 */
public class ContactsDisplaySettings extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_contacts_display, container, false);

        RecyclerView RV = (RecyclerView) v.findViewById(R.id.ContactRecylerView);
        ContactRecyclerViewAdapter adapter = new ContactRecyclerViewAdapter(controller.retrieveContacts(), getContext());
        RV.setAdapter(adapter);
        LinearLayoutManager lnyd = new LinearLayoutManager(getContext());
        lnyd.setOrientation(LinearLayoutManager.VERTICAL);
        RV.setLayoutManager(lnyd);
